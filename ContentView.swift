    ...
    var body: some View {
        NavigationView {
            ...
            VStack {
                ...
                NavigationLink(destination: ListeDesSousComptes()) {
                                        Text("Go to ListeDesSousComptes")
                                            .font(.system(size: 20))
                                            .foregroundColor(.white)
                                            .frame(minWidth: 0, maxWidth: .infinity)
                                            .padding()
                ...
                NavigationLink(destination: AjoutCreditSousCompte()) {
                                        Text("Go to AjoutCreditSousCompte")
                                            .font(.system(size: 20))
                                            .foregroundColor(.white)
                                            .frame(minWidth: 0, maxWidth: .infinity)
                                            .padding()
